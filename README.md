...
The [#sandbox-cleardown](https://hmcts-reform.slack.com/archives/C04PBAYU35E) slack channel has been created to post warning messages on resources that are scheduled to be cleared down in the sandbox environment.
